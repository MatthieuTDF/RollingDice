...
public class RollTest {
    ...
    public void singleD6Roll() {
        ...
        Assert.assertEquals(4, rollTest.roll(Roll.RollType.NORMAL));
    }

    @Test
    public void singleD6RollWithAd() {
        Roll rollTest = new Roll(6, 1, 0);
        Assert.assertEquals(4, rollTest.roll(Roll.RollType.ADVANTAGE));
    }

    @Test
    public void singleD6RollWithModifierPositive() {
        Roll rollTest = new Roll(6, 1, 2);
        Assert.assertEquals(6, rollTest.roll(Roll.RollType.NORMAL));
    }

    @Test
    public void multipleD6RollWithModifierPositive() {
        Roll rollTest = new Roll(6, 2, 2);
        Assert.assertEquals(10, rollTest.roll(Roll.RollType.NORMAL));
    }
    ...
    public void multipleD6RollWithModifierNegativeResultBelowZero() {
        ...
        Assert.assertEquals(0, rollTest.roll(Roll.RollType.NORMAL));
    }

    @Test
    public void zeroAsNumberRoll() {
        Roll rollTest = new Roll(6, 0, 2);
        Assert.assertEquals(-1, rollTest.roll(Roll.RollType.NORMAL));
    }
    ...
    public void simpled6Formula() {
        ...
        Assert.assertEquals(8, rollTest.roll(Roll.RollType.NORMAL));
    }
    ...
    public void simpled6FormulaWithoutFirstDigitWithModifier() {
        ...
        Assert.assertEquals(5, rollTest.roll(Roll.RollType.NORMAL));
    }

    @Test
    public void simpled6FormulaWithPositiveModifier() {
        Roll rollTest = new Roll("2d6+1");
        Assert.assertEquals(9, rollTest.roll(Roll.RollType.NORMAL));
    }

    @Test
    public void simpled6FormulaWithNegativeModifier() {
        Roll rollTest = new Roll("2d6-1");
        Assert.assertEquals(7, rollTest.roll(Roll.RollType.NORMAL));
    }
